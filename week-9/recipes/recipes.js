...
const recipes = [
	{
        ...
        alt: "Image of sweet potato waffles",
		recipeIngredient: [
			'2 separated eggs',
			'1/4 C Oil',
			'1/4 tsp salt',
	...
	},
	{
        ...
        alt: "Image chicken with cream and steamed green beans ",
		recipeIngredient: [
	...
	},
	{
        ...
        alt: "Image of oven roasted potato slices",
		recipeIngredient: [
			'3-4 Medium Potatoes',
			'1 Tbsp Olive oil',
	...
	},
	{
        ...
        alt: "Image of black beans and rice",
		recipeIngredient: [
	...
	},
	{
        ...
        alt: "Image chocolate chip cookies",
		recipeIngredient: [
	...
	},
	{
        ...
        alt: "Image of gooseberry with vanilla cream and crumble",
		recipeIngredient: [
			'For the Cake Base:',
	...
	},
	{
        ...
        alt: "Image of apple crisp and vanilla ice cream",
		recipeIngredient: [
...
/* Get Elements */
const searchBtn = document.getElementById("forSearch");
...
/* Searches food to find the matching phrase */
function searchFood(phrase){
    return recipes.filter((recipe) =>{
        return recipe.name.toLowerCase().includes(phrase);
    })
};

/* Adds foods to the screen */
function render(foods){
    food_container.innerHTML = "";

    foods.forEach((food) =>{
        const newDiv = document.createElement("div");
        newDiv.classList.add("food_card");

        newDiv.innerHTML = `
             <img class="food-img" src = "${food.image}" alt= "${food.alt}">
        ...
        const foodInfo = newDiv.querySelector(".food_info");

        //Create tags container
        const tagDiv = document.createElement("div");
        tagDiv.classList.add("food-tags");
        tagBtn(food,tagDiv);

        //Creating rating div
        const ratingDiv = document.createElement("div");
        ratingDiv.classList.add("rating");
        ratingDiv.innerHTML = rating(food.rating);

        //Adds this to the food container to make it appear
        foodInfo.appendChild(tagDiv);
        foodInfo.appendChild(ratingDiv);

        //Adds the food container to the screen
        food_container.appendChild(newDiv);
    })
}

/* Creates function that adds the tags */
function tagBtn(food,container){
...
/* Creates a function that adds stars rating*/
